...
/**
 * Requester retries a FAILED background Travy (EN+ZH) render from the
 * distribution-review step. Clears the recorded error and re-dispatches the
 * supervised Travy render.
 */
