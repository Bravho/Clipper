...
import { rejectRequestSchema } from "@/features/staff/validation/staffActionSchemas";

/**
 * POST /api/staff/requests/[id]/reject
 * Reject a request with a reason shown to the requester.
 */
export async function POST(
  ...
  try {
    ...
    const request = await staffWorkflowService.rejectRequest(
      params.id,
