    ...
    <div className="mx-auto w-full min-w-0 max-w-2xl px-4 py-10">
      ...
      <PolicySection
        ...
        items={[
          ...
          "Your first eligible request is free to generate, preview and download, and its video carries no watermark.",
          "The next three requests are free to generate and preview with a watermark; removing the watermark and downloading currently costs 50 credits.",
          "After that allowance, each request costs 50 credits, charged before generation begins, and the delivered video carries no watermark.",
