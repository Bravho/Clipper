export enum VideoGenerationStep {
  ...
  // Step 3 - iAppTTS AI voice generation (local Python server, no human recording needed)
  GeneratingVoice         = "generating_voice",
  AwaitingVoiceApproval   = "awaiting_voice_approval",

  // Step 3.5 - Claude AI generates animation/graphic overlays synced to voice timeline
